...
imagen10 = PhotoImage(file="botonverde2.png")
imagenverde = ttk.Button(IzqFrame,background="#333333",relief="flat")
imagenverde.grid(column=1,row=1,sticky=(W))
imagenverde['image'] = imagen10

imagen11 = PhotoImage(file="botonverde2.png")
imagenverde = ttk.Button(IzqFrame,background="#333333",relief="flat")
imagenverde.grid(column=1,row=2,sticky=(W))
imagenverde['image'] = imagen11

imagen12 = PhotoImage(file="botonverde2.png")
imagenverde = ttk.Button(IzqFrame,background="#333333",relief="flat")
imagenverde.grid(column=1,row=3,sticky=(W))
imagenverde['image'] = imagen12

imagen13 = PhotoImage(file="botonrojo2.png")
imagenverde = ttk.Button(IzqFrame,background="#333333",relief="flat")
imagenverde.grid(column=1,row=4,sticky=(W))
imagenverde['image'] = imagen13

imagen14 = PhotoImage(file="botonrojo2.png")
imagenrojo = ttk.Button(IzqFrame,background="#333333",relief="flat")
imagenrojo.grid(column=1,row=5,sticky=(W))
imagenrojo['image'] = imagen14

imagen15 = PhotoImage(file="botonrojo2.png")
imagenverde = ttk.Button(IzqFrame,background="#333333",relief="flat")
imagenverde.grid(column=1,row=6,sticky=(W))
imagenverde['image'] = imagen15
